...
def print_system_info():
    ...
    print("│   ├── output_video.mp4  # Processed output")
...
def print_features():
    ...
    print("• Person Tracking: DeepSORT for robust tracking")
...
def print_configuration():
    ...
    print("• TRACKING_ALGORITHM = 'deepsort'")
    print()
...
def print_technical_details():
    ...
    print("• DeepSORT: Handles occlusion, reappearance, ID persistence")
...
def print_output_examples():
    ...
    print()
    print("Video Output:")
    print("• assets/output_video.mp4 - Processed video with overlays")
